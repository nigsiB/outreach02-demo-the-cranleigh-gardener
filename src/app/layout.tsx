      ...
      <body className="flex min-h-screen flex-col antialiased">
        <header className="bg-[#2d5a3d] text-white">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            <Link href="/" className="inline-flex items-center rounded-sm transition-transform hover:-translate-y-0.5">
              <Image src="/cranleigh-gardener-logo-white.png" alt="The Cranleigh Gardener" width={706} height={183} className="h-auto w-[154px] sm:w-[188px]" priority />
            </Link>
